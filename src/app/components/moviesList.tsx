...
export const MoviesList = () => {
  ...
  const handleModal = useCallback((e:any, imdbId:any) => {
    e.stopPropagation();
    dispatch(showModal({ id: 'MOVIE', imdbId: imdbId }));
  }, [dispatch]);

  const handleWatchlist = useCallback((e:any, imdbId:any) => {
    e.stopPropagation();
    info.map((item:any) => {
                    ...
                    {item ? (
                      <div className="flex items-center w-full justify-between mt-4">
                        ...
                        <div
                          ...
                          onClick={(e) => handleModal(e, item.imdbID)}
                        >
